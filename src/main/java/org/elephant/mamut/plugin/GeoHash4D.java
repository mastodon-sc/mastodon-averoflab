...
public final class GeoHash4D implements Comparable< GeoHash4D >, Serializable
{
     ...
     */
    public static GeoHash4D withCharacterPrecision( double x, double y, double z, double t, int numberOfCharacters )
    {
        ...
        return new GeoHash4D( x, y, z, t, desiredPrecision );
    }
     ...
     */
    public static String geoHashStringWithCharacterPrecision( double x, double y, double z, double t, int numberOfCharacters )
    {
        GeoHash4D hash = withCharacterPrecision( x, y, z, t, numberOfCharacters );
        return hash.toBase32();
    }

    private GeoHash4D( double x, double y, double z, double t, int desiredPrecision )
    {
    ...
    /**
     * how many significant bits are there in this {@link GeoHash4D}?
     */
    ...
    /**
     * get the base32 string for this {@link GeoHash4D}.<br>
    ...
    public boolean equals( Object obj )
    {
        ...
        if ( obj instanceof GeoHash4D )
        {
            GeoHash4D other = ( GeoHash4D ) obj;
    ...
    @Override
    public int compareTo( GeoHash4D o )
    {
